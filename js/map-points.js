...
const imgPaths = {
    "Floor0": {
        ...
        dots: {
            "dot2": { x: 0.18500, y: 0.38048, desc: "Sala 2 (girl team)" }, // sala 2
            "dot3": { x: 0.25200, y: 0.46108, desc: "Sala 3 (historia)" }, // sala 3
            "dot4": { x: 0.25100, y: 0.74882, desc: "Dyrektor" }, // dyrektor
            "dot5": { x: 0.24900, y: 0.87972, desc: "Sala 10 (j. polski)" }, // sala 10
            "dot6": { x: 0.10200, y: 0.87972, desc: "Sala 13 (matematyka)" }, // sala 13
            "dot7": { x: 0.10300, y: 0.65912, desc: "Sekretariat uczniowski" }, // sekretariat uczniowski
            "dot8": { x: 0.39300, y: 0.49505, desc: "Sala 22 (technik automatyk)" }, // sala 22
            "dot9": { x: 0.53700, y: 0.49505, desc: "Sala 24 (sumoboty)" }, // sala 24
            "dot10": { x: 0.76000, y: 0.56011, desc: "Sala 46 (filozofia, religia)" }, // sala 46
            "dot11": { x: 0.83700, y: 0.63366, desc: "Sala 45 (j. angielski)" }, // sala 45
            "dot12": { x: 0.89100, y: 0.54173, desc: "Toaleta A (1)" }, // kibel meski
            "dot13": { x: 0.75900, y: 0.36775, desc: "Psycholog" }, // psycholog
            "dot14": { x: 0.76100, y: 0.21075, desc: "Sala 32 (chemia, biologia)" }, // sala 32
            "dot15": { x: 0.76100, y: 0.10750, desc: "Sala 39 (technik energetyk*)" }, // sala bez numerku raz byla na niemieckim i historii
            "dot16": { x: 0.91300, y: 0.16124, desc: "Sala 40 (technik mechatronik)" }, // sala 40 znak zapytania
            "dot17": { x: 0.91100, y: 0.29562, desc: "Sala 40 (technik mechatronik)" }, // sala 41
            "dot18": { x: 0.91000, y: 0.47524, desc: "SCHODY B - GÓRA" }, // schody b gora
            "dot19": { x: 0.90900, y: 0.43706, desc: "SCHODY B - DÓL" }, // schody b dol
            "dot20": { x: 0.09200, y: 0.52900, desc: "SCHODY A - GÓRA" }, // schody a gora
    ...
    "Floor1": {
        dots: {
            ...
            "dot5A": { x: 0.10200, y: 0.68686, desc: "Sala 119 (wolontariat)" }, // sala 119
            "dot6A": { x: 0.41644, y: 0.49513, desc: "Sala gimnastyczna" }, // Sala gimnastyczna
            "dot7A": { x: 0.26867, y: 0.71279, desc: "Pielęgniarka" }, // Pielegniarka A

            "dot7.5A": { x: 0.25083, y: 0.84552, desc: "Sala 113 (TRN)" }, // Sala 113

            "dot8B": { x: 0.75978, y: 0.53285, desc: "Sala 123 (technik programista)" }, // Sala 123
            "dot9B": { x: 0.83400, y: 0.61771, desc: "Sala 122 (technik programista)" }, // Sala 122
            "dot10B": { x: 0.90756, y: 0.37097, desc: "Toaleta B" }, // Toaleta pracownicza B
            "dot11B": { x: 0.90867, y: 0.25310, desc: "Sala 138 (technik elektronik)" }, // Sala 138
            "dot12B": { x: 0.90867, y: 0.14152, desc: "Sala 134 (technik elektryk)" }, // Sala 134
            "dot13B": { x: 0.76311, y: 0.14466, desc: "Sala 135 (technik elektronik)" }, // Sala 135
    ...
    "Floor2A": {
        dots: {
            "dot1": { x: 0.53750, y: 0.21385, desc: "Sala 202 (j. angielski)" }, // Sala 202
            "dot2": { x: 0.31250, y: 0.30308 }, // WC meskie
            "dot3": { x: 0.31250, y: 0.51692 }, // WC zenskie
            "dot4": { x: 0.74500, y: 0.28308 }, // Sala 203
            "dot5": { x: 0.74500, y: 0.48923, desc: "Sala 204 (j. polski)" }, // Sala 204
            "dot6": { x: 0.74500, y: 0.69077, desc: "Sala 205 (matematyka)" }, // Sala 205
            "dot7": { x: 0.74500, y: 0.79846, desc: "Sala 207 (fizyka)" }, // Sala 207
            "dot8": { x: 0.41500, y: 0.88308, desc: "Sala 210 (matematyka)" }, // Sala 210
            "dot9": { x: 0.31250, y: 0.68923 }, // Biblioteka

            "Wdot1": { x: 0.31000, y: 0.44000, connections: ['Wdot2'] }, // Schody w dol
    ...
    "Floor2B": {
        dots: {
            "dot1": { x: 0.50000, y: 0.89231, desc: "Sala 215 (j. niemiecki)" }, // Sala 215
            "dot2": { x: 0.28750, y: 0.78769 }, // Sala 216
            "dot3": { x: 0.28250, y: 0.62462 }, // Sala 219
            "dot4": { x: 0.28250, y: 0.46154, desc: "Sala 221 (technik informatyk)" }, // Sala 221
            "dot5": { x: 0.27500, y: 0.30615, desc: "Sala 222 (t. informatyk, programista)" }, // Sala 222
            "dot6": { x: 0.29750, y: 0.23385, desc: "Sala 224 (technik informatyk)" }, // Sala 224
            "dot7": { x: 0.70500, y: 0.23538, desc: "Sala 226 (technik informatyk)" }, // Sala 226
            "dot8": { x: 0.69750, y: 0.37385 }, // Sala 227
            "dot9": { x: 0.70500, y: 0.56154 }, // WC zenskie
            "dot10": { x: 0.70500, y: 0.78769 }, // WC meskie

            "Wdot1": { x: 0.71750, y: 0.65385, connections: ['Wdot2'] }, // Schody w dol
